...
def ExportPST(pstStore, folder, NewFolder, TotalCount, rdoSession, rdoNewPSTSession, MsgIds, QC):
...
def main(argv):
	...
	if ExportArg:
		if ExportArg == 'pst2pst':
			...
			TotalCount, QC = ExportPST(pstStore, rootFolder, NewRootFolder, TotalCount, rdoSession, rdoNewPSTSession, MsgIds, QC)
